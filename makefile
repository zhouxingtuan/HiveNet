...
LUAHIREDIS_STATICLIB := ./lua/luahiredis/libhiredis.a
LUAHIREDIS_INC := ./lua/luahiredis/

TOLUA_INC := ./lua/tolua/

LUA_SCRIPT_INC := ./lua

HIVENET_STATICLIB := $(JEMALLOC_STATICLIB) $(LUAJIT_STATICLIB) $(LUASQL_STATICLIB) $(LUAHIREDIS_STATICLIB) $(LUASOCKET_STATICLIB)
...
INCLUDES = -I$(LUAJIT_INC) -I$(TOLUA_INC) -I$(OPENSSL_INC) -I$(LUASQL_INC) -I$(LUAHIREDIS_INC) -I$(LUASOCKET_INC) -I$(LUA_SCRIPT_INC) -I$(HIVENET_INC) -I$(JEMALLOC_INC)
